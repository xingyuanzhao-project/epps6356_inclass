...
# Note the order
png("a2p1.png", width=800, height=600)
...
png("a2p2.png", width=800, height=600)
...
# Histogram
# Random data
png("a2p3.png", width=800, height=600)
Y <- rnorm(50)
...
# Barplot
png("a2p4.png", width=800, height=600)
...
# Boxplot
png("a2p5.png", width=800, height=600)
par(mar=c(3, 4.1, 2, 0))
...
# Persp
png("a2p6.png", width=800, height=600)
...
# Piechart
png("a2p7.png", width=800, height=600)
